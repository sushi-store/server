...
class CategorySerializer(serializers.ModelSerializer):
    ...
    def get_category_name(self, category):
        return {'en': category.category_name, 'uk': category.category_name_uk}
...
class IngredientSerializer(serializers.ModelSerializer):
    ...
    def get_name(self, ingredient):
        return {'en': ingredient.name, 'uk': ingredient.name_uk}
...
class SushiSerializer(serializers.ModelSerializer):
    ...
    def get_name(self, sushi):
        return {"en": sushi.name, "uk": sushi.name_uk}

    def get_description(self, sushi):
        return {"en": sushi.description, "uk": sushi.description_uk}

    def get_category_name(self, sushi):
        return {"en": sushi.category.category_name, "uk": sushi.category.category_name_uk}
